function [] = number_of_subjects_effect_rlb(thick,vol,area,thick2,vol2,area2, max_subject_num)
%This function computes the effect of the number of subjects on the
%reliability of the structural covariance. It computes the average 
%difference between SC matrices (of different subjects) 
...
for subject_num = 5:5:max_subject_num
    for iterations = 1:1000
        ...
        index = randperm(max_subject_num);
        data1 = thick(index(1:subject_num),:);
        data2 = thick2(index(1:subject_num),:);
...
for subject_num = 5:5:max_subject_num
    for iterations = 1:1000
        ...
        data2 = vol2(index(1:subject_num),:);
...
for subject_num = 5:5:max_subject_num
    for iterations = 1:1000
        ...
        data2 = area2(index(1:subject_num),:);
